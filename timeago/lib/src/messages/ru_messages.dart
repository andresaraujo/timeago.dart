...
class RuMessages implements LookupMessages {
  ...
  @override
  String lessThanOneMinute(int seconds) => '1 минуту';
  @override
  String aboutAMinute(int minutes) => '1 минуту';
  @override
...
class RuShortMessages implements LookupMessages {
  ...
  @override
  String minutes(int minutes) => 'мин.';
  @override
  String aboutAnHour(int minutes) => '~1 ч.';
  @override
  String hours(int hours) => 'ч.';
  @override
  String aDay(int hours) => '~1 д.';
  @override
  String days(int days) => 'д.';
  @override
  String aboutAMonth(int days) => '~1 мес.';
  @override
  String months(int months) => 'мес.';
  @override
  String aboutAYear(int year) => '~1 г.';
  @override
  String years(int years) => 'г.';
  @override
  String wordSeparator() => ' ';
}